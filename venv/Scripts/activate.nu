...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\JC INTER\Inmakes project\travelproject\travelproject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\JC INTER\Inmakes project\travelproject\travelproject\venv\Scripts\deactivate.nu'
